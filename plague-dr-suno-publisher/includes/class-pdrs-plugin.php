...
final class PDRS_Plugin {
    ...
    public static function register_post_type(): void {
        ...
        register_post_meta( self::POST_TYPE, '_pdrs_artist_name', array( 'type' => 'string', 'single' => true, 'show_in_rest' => false, 'sanitize_callback' => 'sanitize_text_field', 'auth_callback' => static fn(): bool => current_user_can( 'edit_pages' ) ) );
